                ...
                <div className="flex flex-col items-center">
                    ...
                    {tab !== "forgot_password" && (
                        <>
                            ...
                            <button className="w-full flex items-center justify-center gap-3 py-3 px-4 bg-white dark:bg-zinc-900 border border-slate-200 dark:border-zinc-800 rounded-xl hover:bg-slate-50 dark:hover:bg-zinc-800 transition-all group mb-6 shadow-sm cursor-pointer">
