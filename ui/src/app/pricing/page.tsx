    ...
    <div className="max-w-5xl mx-auto px-6 py-12 pb-24">
      <div className="text-center max-w-2xl mx-auto mb-16">
        <motion.h2
          ...
          className="text-muted-foreground font-medium uppercase tracking-widest text-xs mb-4"
        >
          Membership
        </motion.h2>
        <motion.h1
      ...
      <div className="space-y-6">
        ...
        <motion.div
          ...
          transition={{ duration: 0.5 }}
          className="group relative bg-card border border-border rounded-3xl p-6 md:p-8 transition-all hover:bg-card/80 hover:border-border/80"
        >
        ...
        <motion.div
          ...
          viewport={{ once: true, margin: "-100px" }}
          transition={{ duration: 0.5, delay: 0.1 }}
          className="relative bg-primary text-primary-foreground rounded-3xl p-6 md:p-8 shadow-2xl shadow-primary/20 transform transition-all hover:scale-[1.01]"
        >
        ...
        <motion.div
          ...
          viewport={{ once: true, margin: "-100px" }}
          transition={{ duration: 0.5, delay: 0.2 }}
          className="group relative bg-card border border-border rounded-3xl p-6 md:p-8 transition-all hover:border-primary/50 overflow-hidden"
        >
