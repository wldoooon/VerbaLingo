          ...
          <div className="relative rounded-3xl bg-primary px-6 py-16 sm:px-16 sm:py-24 text-center overflow-hidden">
            ...
            <div className="relative z-10 max-w-2xl mx-auto space-y-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <button className="h-12 px-8 rounded-full bg-background text-foreground font-semibold hover:bg-background/90 transition-colors shadow-lg active:scale-95">
